        ...
        <Context.Provider value={[currentUser, setCurrentUser]}>
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/manager/books" element={<Books />} />
                    <Route path="/manager/lends" element={<Lends />} />

                    <Route path="/subscriber/homepage" element={<SubscriberHomepage />} />
                    <Route path="/subscriber/lendBook" element={<LendBook />} />
                    <Route path="/subscriber/lendsHistory" element={<LendsHistory />} />
                    <Route path="/subscriber/returnBook" element={<ReturnBook />} />
